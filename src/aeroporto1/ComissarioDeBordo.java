...
public class ComissarioDeBordo extends javax.swing.JFrame {

    ArrayList<ComissarioDeBordoC> array= new ArrayList<>();
    public ComissarioDeBordo() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Cadastro de Comissario");
...
void exibir(){
  DefaultListModel dlm = new  DefaultListModel();
        ...
        while(it.hasNext()){
            ComissarioDeBordoC c= (ComissarioDeBordoC) it.next();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            empresa=jEmpresa.getSelectedItem()+"";
            System.out.println(empresa);
            c = new ComissarioDeBordoC(empresa, nome, cpf, idade, sexo);
            array.add(c);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ComissarioDeBordo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ComissarioDeBordo().setVisible(true);
            }
        });
    }
